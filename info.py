...
BOT_TOKEN = environ.get('BOT_TOKEN', "8536587558:AAFv06dPKSdJrNxe2diwHhwGIJGeJNXZgXk")
...
PICS = (environ.get('PICS', 'https://graph.org/file/79a936b9c4b94e07252ad-00ede945aa92166110.jpg https://graph.org/file/55a4a9b9f598fd11f59dd-c27db46a1e0cc4b589.jpg https://graph.org/file/380f323426207af275677-066d3b6c6190971cf6.jpg https://graph.org/file/26127a43f5df258ef1769-42a525a362d8d2d02d.jpg https://graph.org/file/e1f896845298a3b3ce1fc-b3c8ca7d38797484d7.jpg https://graph.org/file/7546badd2a6aae5e630bf-41fe5ecfee4cfbd1cc.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8452579484').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003408919601 -1003370992067').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003320166866'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003320166866'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1001681286512'))  # Notification of those who verify will be sent to your channel
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003320166866')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003320166866')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001681286512').split()]
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/242b7f1b52743938d81f1.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://SACHIN_DB:SACHIN_DB@cluster0.7jn4oby.mongodb.net/?appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://ASMOVIE_DA:ASMOVIE_DA@cluster0.grfdxbo.mongodb.net/?appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinema_Lokam_Movies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Cinema_Updates_OTT')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Ascreator')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Cinema_Updates_OTT')
OWNERID = int(os.environ.get('OWNERID', '8452579484'))  # Replace with the actual admin ID
